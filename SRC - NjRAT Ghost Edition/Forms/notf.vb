                ...
                Try
                    ...
                    SyncLock items
                        ...
                        For Each class2 In Me.Items
                            ...
                            graphics.DrawString(class2.string_0, Me.Font, Brushes.White, 5.0!, CSng(class2.int_0))
...
Label_0232:
                        ...
                        If ((Me.Items.Count > 0) And Not Me.bool_0) Then
                            If IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory & "\Sound\Sound.wav") Then
                                My.Computer.Audio.Play(AppDomain.CurrentDomain.BaseDirectory & "\Sound\Sound.wav", AudioPlayMode.Background)
                            Else
                            End If
                            Me.back()
                            End If
